...
<html>
	...
	<title>Ups Normal &mdash; Resto & Coffee</title>
				...
				<div class="col-md-12 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							<h1>The Best Coffee <em>&amp;</em> Restaurant <em>in</em> Jakarta</h1>
							<h2>Experience the great food</h2>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					<div class="section-heading">
						...
						<p>Ups Normal Cafe & Restaurant is a perfect location and no matter the occasion, you are guaranteed with unique dining experience. Whether you are after an intimate dinner for two or a private party, we cater for all. Ups Normal has a function room for up to 40 people. The room has its own bar and sound system so you can enjoy a truly sensational and private event.</p>
						<p><a href="/ebuss/about.php" class="btn btn-primary btn-outline">About us</a></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
					<div class="fh5co-item">
						...
						<span class="fh5co-price">Rp 100.<sup>000</sup></span>
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
					<div class="fh5co-item margin_top">
						...
						<span class="fh5co-price">Rp 52.<sup>000</sup></span>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos nihil cupiditate ut vero alias quaerat inventore molestias vel suscipit explicabo.</p>
					</div>
				</div>
			</div>
					   			...
					   			<div class="row">
						   			<div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
						   				<div class="slider-text-inner">
						   					<div class="desc">
													<h2>Waffles<em>with</em>honey-dipping sauce</h2>
					   		...
					   		<div class="container-fluid">
					   			<div class="row">
						   			<div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
						   				<div class="slider-text-inner">
						   					<div class="desc">
													<h2>Mixed Vegetables <em>with</em> peanuts sauce</h2>
													<p>Ink is a free html5 bootstrap and a multi-purpose template perfect for any type of websites. A combination of a minimal and modern design template. The features are big slider on homepage, smooth animation, product listing and many more</p>
													<p><a href="#" class="btn btn-primary btn-outline">Learn More</a></p>
						   					</div>
						   				</div>
			...
			<div id="fh5co-blog" class="fh5co-section">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="fh5co-blog animate-box">
								<a href="#" class="blog-bg" style="background-image: url(/ebuss/images/wine.jpg);"></a>
								<div class="blog-text">
									<span class="posted_on">Feb. 15th 2016</span>
									<h3><a href="#">Wine Library</a></h3>
									<p>Our private event lunch and dinner menus change seasonally and offer several choices to accommodate a variety of tastes, while our wine list has more than 100 selections from small producers around the world.</p>
									<ul class="stuff">
